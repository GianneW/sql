...
FROM customer;
-- I think we discuss why not use select * inclass
...
LIMIT 10;
-- I remembered he said try not to use LIMIT, should I use where rownum<=10 here?
...
SELECT product_id, product_name, 
	CASE WHEN product_qty_type = "unit" THEN "unit"
		WHEN product_qty_type ISNULL THEN NULL
		-- I saw there are some null values in the table
		ELSE "bulk" 
...
SELECT v.*, booth_number, market_date
FROM vendor v
